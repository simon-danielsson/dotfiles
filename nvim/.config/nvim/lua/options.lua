...
function M.setup()
    ...
    -- search
    opt.path:append("*"); opt.hlsearch = true; opt.ignorecase = true;
    opt.smartcase   = true; opt.incsearch = true; opt.wildmenu = true;
    opt.wildoptions = "pum,fuzzy"; opt.wildmode = "noselect:lastused,full"
    opt.wildignore:append({ "*.o", "*.obj",
        "*.pyc", "*.class", "*.jar" })

    -- file handling
    vim.opt.shada   = "'100,<100,s10,h,:1000,@1000"
    opt.undofile    = true
    ...
    -- folds
    opt.foldcolumn   = "2"; o.foldmethod = "marker"; o.foldlevelstart = 99
    o.foldenable     = false
