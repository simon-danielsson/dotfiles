...
I use a mac as my main machine but on my linux machines I'm using voidlinux/i3 (which is the most perfect OS config that exists), and so I've tried my hardest to emulate that workflow on my mac by using tools such as [aerospace](https://github.com/nikitabobko/AeroSpace) and [simplebar](https://github.com/Jean-Tinland/simple-bar).
