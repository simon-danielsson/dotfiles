...
### Native `lua/native/`
- 🔱 **trident.lua**: A Neovim-native interpretation of [harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2). Buffers are not added manually like in harpoon, but are instead added and subtracted from the list automatically. A maximum of 6 buffers can exist on the list at once, to minimize friction. The list will automatically rotate when a listed buffer is closed.
