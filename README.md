...
I use a mac as my main machine but on my linux machines I'm using voidlinux/i3 (the most perfect workflow that exists), and so I've tried my hardest to emulate that on my mac by using tools such as [aerospace](https://github.com/nikitabobko/AeroSpace) and [simplebar](https://github.com/Jean-Tinland/simple-bar).
